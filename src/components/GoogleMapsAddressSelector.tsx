...
const GoogleMapsAddressSelector = ({ onAddressSelect, apiKey }) => {
  ...
  const center = { lat: -34.603722, lng: -58.381592 }; // Buenos Aires
  ...
  const setupEventListeners = (mapInstance, markerInstance, autocompleteInstance) => {
      ...
      <div className="w-full p-6 bg-red-50 border border-red-200 rounded-lg">
        ...
        <div className="mt-3 text-sm text-red-500">
          ...
          <ul className="list-disc list-inside mt-1 space-y-1">
            ...
            <li>Tengas habilitadas las APIs: Maps JavaScript API y Places API</li>
...
function GoogleMapsExample() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-800 mb-2">Google Maps con Autocompletado</h1>
      ...
      {GOOGLE_MAPS_API_KEY === process.env.NEXT_PUBLIC_GMAPS_API_KEY && (
        <div className="mb-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
          ...
          <p className="mt-2 text-yellow-600">
            Reemplaza <code className="bg-yellow-100 px-2 py-1 rounded">'TU_API_KEY_AQUI'</code> con tu API Key de Google Maps
          </p>
        </div>
      )}
...
export default function AddressMapSelector({onAddressSelect}) {
    ...
    return (
      <div className="max-w-4xl mx-auto p-6">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-800 mb-2">Ubicacion de entrega</h1>
          <p className="text-gray-600"> Selecciona la ubicacion de entrega y luego validar la ubicacion.</p>
        </div>
        ...
        <button type="button" onClick={handleClick} className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg transition-colors">Validar ubicacion</button>
